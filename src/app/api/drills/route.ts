...
export const GET = withObservability(getHandler, { route: 'drills', getSession: auth });
export const POST = withObservability(postHandler, { route: 'drills', getSession: auth });
