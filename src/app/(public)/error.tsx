// App Router error boundary for public routes — catches unhandled errors with minimal UI
'use client';

import type { AppRouterErrorProps } from '@/components/ui/ErrorBoundary/ErrorBoundary.types';

export default function PublicError({ error, reset }: AppRouterErrorProps) {
  return (
