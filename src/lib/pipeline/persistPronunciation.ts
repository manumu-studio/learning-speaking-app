...
// Internal helpers exported for testing only — underscore prefix signals non-public API.
export { mapAzureScore as _mapAzureScore, mapSpeakingRate as _mapSpeakingRate };
