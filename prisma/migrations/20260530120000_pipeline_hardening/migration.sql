-- AlterEnum
ALTER TYPE "SessionStatus" ADD VALUE 'AWAITING_FINAL';
ALTER TYPE "SessionStatus" ADD VALUE 'PROCESSING_FINAL';

-- AlterTable
ALTER TABLE "speaking_sessions" ADD COLUMN "processedAt" TIMESTAMP(3);
